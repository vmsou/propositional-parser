...
class PropositionalParser : public Parser {
    ...
    // Grammar
    public:
        bool is_constant(std::deque<Token>& tokens, bool single=true);
        bool is_proposition(std::deque<Token>& tokens, bool single=true);
        bool is_open_parenthesis(std::deque<Token>& tokens, bool single=true);
        bool is_close_parenthesis(std::deque<Token>& tokens, bool single=true);
